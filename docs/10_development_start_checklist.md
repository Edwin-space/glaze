...
- [x] macOS 네트워크 브라우저를 Finder식 위치 사이드바·상단 경로 바·아이콘/목록/계층/갤러리 보기로 개편하고 명시적 뒤로 가기(⌘[) 적용 (2026-09-02)
- [x] WebDAV 현재 폴더 즐겨찾기와 60초 폴더 캐시, 중복·지연 응답 무효화, URL 표기 차이로 생기는 자기 폴더 항목 제거 (2026-09-02)
